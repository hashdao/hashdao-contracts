...
/// @notice Redemption contract that transfers registered tokens from Hash DAO in proportion to burnt DAO tokens.
contract HashDAOredemption is ReentrancyGuard {
